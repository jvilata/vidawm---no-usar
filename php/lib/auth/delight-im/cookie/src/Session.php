...
final class Session {
	 ...
	 */
	public static function start($sameSiteRestriction = Cookie::SAME_SITE_RESTRICTION_NONE) {//LAX
	 ...
	 * @param string|null $sameSiteRestriction indicates that the cookie should not be sent along with cross-site requests (either `null`, `Lax` or `Strict`)
	 */
	private static function rewriteCookieHeader($sameSiteRestriction = Cookie::SAME_SITE_RESTRICTION_LAX) {//LAX
