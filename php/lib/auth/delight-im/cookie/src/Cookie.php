...
final class Cookie {
	...
	const SAME_SITE_RESTRICTION_NONE = 'None';//jv
	...
	public function __construct($name) {
		...
		$this->httpOnly = true;//true
		$this->secureOnly = true; // false
		$this->sameSiteRestriction = self::SAME_SITE_RESTRICTION_LAX; //self::SAME_SITE_RESTRICTION_LAX;
	}
