            ...
            <q-btn icon="more_vert"  class="q-ma-xs" color="primary" dense>
              <q-menu ref="menu1">
                <q-list dense>
                  ...
                  <q-item key="print1" clickable v-close-popup @click.native="imprimirLiquidacion(registrosSeleccionados[0].id, 1)" >
                    <q-item-section avatar>
                      <q-icon name="brightness_5" />
                    </q-item-section>
                    <q-item-section>Regenerar liquidación</q-item-section>
                  </q-item>
                  <q-item key="excel1" clickable v-close-popup @click.native="exportarExcel(value.id)" >
                    <q-item-section avatar>
