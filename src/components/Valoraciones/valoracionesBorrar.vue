  ...
  <q-card style="width: 400px;" class="q-pr-xs q-gutter-xs">
    ...
    <q-form @submit="borrarValoraciones" class="q-gutter-y-xs">
      <q-input outlined clearable :rules="[val => !!val || 'Canpo obligatorio']" label="Fecha que se borra" stack-label :value="formatDate(filterR.fecha)" @input="val => filterR.fecha=val" >
